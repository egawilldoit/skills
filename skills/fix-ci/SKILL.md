---
name: fix-ci
description: "Find failing pull-request checks, inspect logs or external check links, and apply the smallest fix that turns them green. Use when CI is red and needs a focused iterative repair, one failure cause at a time. Uses gh pr checks as the source of truth for PR-attached checks."
---
