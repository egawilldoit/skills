...
description: "Create a focused branch from the latest main, complete the work, commit, push, and open a concise pull request with summary and test notes. Use when starting work that should ship through a clean branch and PR. For an existing branch use review-and-ship; for a chain of dependent PRs use integrate-pr-stack."
---
