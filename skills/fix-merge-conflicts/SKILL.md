...
description: "Resolve merge or rebase conflicts non-interactively, preserving both sides where safe, regenerating lockfiles with the package manager, and validating with compile, lint, and tests. Use when a branch has unresolved conflict markers and must reach a buildable state. Do not push during resolution."
---
