...
description: "Review the current branch for bugs, regressions, security, and intent fit, run or add focused tests, commit selected files, and open or update a pull request. Use to finish one ordinary branch or PR. For stacked PRs use integrate-pr-stack; for independent challenge use adversarial-review."
---
